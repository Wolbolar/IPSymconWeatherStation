...
{
    // helper properties
    private const Celsius = 1;
    private const Fahrenheit = 2; // Celsius °C
    private const kmh = 1; // Fahrenheit F
    private const mph = 2; // kmh
    private const pascal = 1; // mph
    private const bar = 2; // pascal
    private const mm = 1; // bar
    private const inch = 2; // mm
    private const Sainlogic = 1; // inch
    private const ELV_WS980WiFi = 2; // Sainlogic
    private const Froggit_WH4000SE = 3; // ELV WS980WiFi
    private $position = 0; // Froggit WH4000SE
    ...
    protected function GetParametersWunderground()
    {
        ...
        $param .= '&indoorhumidity=' . str_replace(',', '.', strval(GetValue($this->GetIDForIdent('Indoor_Humidity'))));
        $param .= '&humidity=' . str_replace(',', '.', strval(GetValue($this->GetIDForIdent('Outdoor_Humidity'))));
        ...
        $param .= '&absbaromin=' . str_replace(',', '.', strval($this->PressurehPaToBar(GetValue($this->GetIDForIdent('absbaromin')))));
        $param .= '&baromin=' . str_replace(',', '.', strval($this->PressurehPaToBar(GetValue($this->GetIDForIdent('baromin')))));
        ...
        $param .= '&solarradiation=' . str_replace(',', '.', strval(GetValue($this->GetIDForIdent('solarradiation'))));
        $param .= '&UV=' . str_replace(',', '.', strval(GetValue($this->GetIDForIdent('UV'))));
    ...
    {
        $formatted_value = str_replace(',', '.',  (string) $value);
        ...
        $form = array_merge_recursive(
            $form, [
                ...
                /*
                    ...
                    'minimum' => 0,
                    'suffix' => 'meter',
                    'caption' => 'altitude above sea level'],
                [
                    'type' => 'ExpansionPanel',
                    ...
                    'items' => [
                        ...
                        [
                            ...
                            'minimum' => 0,
                            'suffix' => 'Seconds',
                            'caption' => 'Update Interval Wunderground']
                    ]],
                [
                    'type' => 'ExpansionPanel',
                    'caption' => 'Weathercloud',
                    'items' => [
                        [
                        ...
                        [
                            ...
                            'minimum' => 0,
                            'suffix' => 'Minutes',
                            'caption' => 'Update Interval Weathercloud']
                    ]],
                [
                    'type' => 'ExpansionPanel',
                    'caption' => 'Ambient Weather',
                    'items' => [
                        [
                            'type' => 'Label',
                        ...
                        [
                            ...
                            'type' => 'ValidationTextBox',
                            'caption' => 'Ambient Weather Passkey'],
                        [
                            'name' => 'UpdateInterval_AmbientWeather',
                            'type' => 'NumberSpinner',
                            'minimum' => 0,
                            'suffix' => 'Seconds',
                            'caption' => 'Update Interval Ambient Weather']
                    ]],
                [
                    'type' => 'ExpansionPanel',
                    'caption' => 'Weatherbug',
                    'items' => [
                        [
                            ...
                            'minimum' => 0,
                            'suffix' => 'Minutes',
                            'caption' => 'Update Interval Weatherbug']
                    ]],
                [
                    'type' => 'ExpansionPanel',
                    'caption' => 'units',
